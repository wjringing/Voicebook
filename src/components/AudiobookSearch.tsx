  ...
  const searchAudiobooks = async (query: string) => {
    ...
    const mockResults: AudiobookResult[] = [
      ...
      }
      {
        ...
        description: 'The definitive vampire novel that created the modern vampire myth.',
        duration: '15h 27m',
        rating: 4.7,
        streamUrl: 'https://archive.org/download/dracula_0810_librivox/dracula_01_stoker_64kb.mp3',
        source: 'LibriVox',
      ...
      },
      {
        ...
        duration: '1h 53m',
        rating: 4.1,
        streamUrl: 'https://archive.org/download/art_war_0811_librivox/artwar_01_suntzu_64kb.mp3',
        source: 'LibriVox',
      ...
      },
      {
        ...
        description: 'An orphaned governess finds love, independence, and her own voice.',
        duration: '19h 10m',
        rating: 4.5,
        streamUrl: 'https://archive.org/download/jane_eyre_0812_librivox/janeeyre_01_bronte_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop',
        genre: 'Romance',
        publishYear: '1847'
      },
      {
        ...
        description: 'A young man\'s portrait ages while he remains forever young and beautiful.',
        duration: '8h 54m',
        rating: 4.4,
        streamUrl: 'https://archive.org/download/picture_dorian_gray_0813_librivox/doriangray_01_wilde_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=400&fit=crop',
      ...
      },
      {
        ...
        duration: '14h 42m',
        rating: 4.3,
        streamUrl: 'https://archive.org/download/tale_two_cities_0814_librivox/twocities_01_dickens_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop',
      ...
      },
      {
        ...
        description: 'A doctor\'s experiment unleashes his dark alter ego.',
        duration: '2h 31m',
        rating: 4.6,
        streamUrl: 'https://archive.org/download/jekyll_hyde_0815_librivox/jekyllhyde_01_stevenson_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=300&h=400&fit=crop',
      ...
      },
      {
        ...
        description: 'The beloved story of the four March sisters growing up during the Civil War.',
        duration: '17h 28m',
        rating: 4.4,
        streamUrl: 'https://archive.org/download/little_women_0816_librivox/littlewomen_01_alcott_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop',
        genre: 'Coming of Age',
        publishYear: '1868'
      },
      {
        ...
        duration: '7h 15m',
        rating: 4.2,
        streamUrl: 'https://archive.org/download/tom_sawyer_0817_librivox/tomsawyer_01_twain_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=400&fit=crop',
        genre: 'Adventure',
        publishYear: '1876'
      },
      {
        ...
        duration: '12h 18m',
        rating: 4.1,
        streamUrl: 'https://archive.org/download/wuthering_heights_0818_librivox/wutheringheights_01_bronte_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop',
      ...
      },
      {
        ...
        description: 'Captain Ahab\'s obsessive quest to kill the great white whale.',
        duration: '22h 47m',
        rating: 4.0,
        streamUrl: 'https://archive.org/download/moby_dick_0819_librivox/mobydick_01_melville_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop',
        genre: 'Adventure',
        publishYear: '1851'
      },
      {
        ...
        duration: '4h 2m',
        rating: 4.3,
        streamUrl: 'https://archive.org/download/wizard_oz_0820_librivox/wizardoz_01_baum_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=400&fit=crop',
        genre: 'Fantasy',
        publishYear: '1900'
      },
      {
        ...
        author: 'Franz Kafka',
        narrator: 'David Richardson',
        description: 'A man wakes up transformed into a giant insect.',
        duration: '1h 47m',
        rating: 4.2,
        streamUrl: 'https://archive.org/download/metamorphosis_0821_librivox/metamorphosis_01_kafka_64kb.mp3',
        source: 'LibriVox',
        coverUrl: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=300&h=400&fit=crop',
